...
import styles from "./workout-exercise-list-screen-styles";

const treinosData: Record<
  string,
  Record<string, { id: string; text: string; numbers: string[] }[]>
> = {
  treino1: {
    Mobilidade: [
      {
...
type WorkoutExerciseListScreenProps = {
  route: RouteProp<RootStackParamList, "WorkoutExerciseList">;
};

const WorkoutExerciseListScreen: React.FC<WorkoutExerciseListScreenProps> = ({
  route,
}) => {
            ...
            >
              <View style={styles.checkboxWrapper}>
                <View
                  style={[
                    styles.checkmark,
                    checkedItems[item.id] && styles.checkedCheckmark,
                  ]}
                >
...
export default WorkoutExerciseListScreen;
